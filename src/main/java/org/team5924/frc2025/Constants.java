...
public final class Constants {
  ...
  public static final double CLIMBER_REDUCTION =
      125.0 / 1.0 * (42.0 / 16.0); // TODO: Elims climber ratio changed, need to update this
  ...
  // max difference between target rotation and current rotation for the climber motor to be
  // considered at the target rotation
