...
public class TunerConstantsGamma {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(2.75).withKI(0).withKD(0).withKS(0.19489).withKV(0.94343);
  ...
  private static final Distance kWheelRadius = Inches.of(2.094);
  ...
  public static final ModuleLimits moduleLimitsFree =
      new ModuleLimits(
          3.83, // max speed in meters per second
